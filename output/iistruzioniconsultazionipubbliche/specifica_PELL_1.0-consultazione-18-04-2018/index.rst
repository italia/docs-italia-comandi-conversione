...
.. toctree::
  ...
  index/TEMA:-Informazioni-cartografiche-e-metainformazion.rst
  index/3.1-CLASSE:-Pod-–-anagrafica-del-punto-di-prelievo.rst
  index/3.2-CLASSE:-Pod---consumi-(POD_C---070803).rst
  index/3.3-CLASSE:-Quadro-elettrico-anagrafica-(QE_A---07.rst
  index/3.4-CLASSE:-Dati-tecnici-quadro-elettrico-(QE_DT--.rst
  index/3.5-CLASSE:-Dati-funzionamento-e-gestione-del-quad.rst
  index/3.6-CLASSE:-Quadro-elettrico-manutenzione-(QE_M---.rst
  index/3.7-CLASSE:-Punto-luce-–-installazione-(PL_IS---07.rst
  index/3.8-CLASSE:-Punto-luce-–-apparecchio-(PL_AP---0708.rst
  index/3.9-CLASSE:-Punto-luce-–-sorgente-luminosa-(PL_SL-.rst
  index/3.10-CLASSE:-Zone-omogenee-(ZO---070812).rst
  index/DATATYPE:-Metadati-di-istanza-(MET_IST---81).rst
  index/DOMINIO:-Fonte-del-dato-(FONTE---0100).rst
  index/DOMINIO:-Scala-(SCALA---0400).rst
