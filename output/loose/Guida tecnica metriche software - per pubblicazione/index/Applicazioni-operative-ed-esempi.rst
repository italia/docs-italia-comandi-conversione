...
| Appl 5        | 880              | 0,9            | 2               |
+---------------+------------------+----------------+-----------------+
| Totale Parco  | 6.850            | 2,26:sup:24\ ` | 3,20:sup:25\ `# |
| Applicativo   |                  | #fn24 <#fn24>` | fn25 <#fn25>`__ |
|               |                  | __             |                 |
+---------------+------------------+----------------+-----------------+
...
-  manutenzione correttiva, che consiste nella modifica del software, eseguita dopo il rilascio:sup:26\ `#fn26 <#fn26>`__, per correggere problemi rilevati;
