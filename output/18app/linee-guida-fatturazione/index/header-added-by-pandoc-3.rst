...
|   | .2. | dati della sede del cedente / prestatore  |                 |   |
|   | 2   |                                           |                 |   |
|   | <Se |                                           |                 |   |
|   | de> |                                           |                 |   |
|   | **  |                                           |                 |   |
...
|   | .2. | prestatore (nome della via, piazza etc.)  | alfanumerico    |   |
|   | 2.1 |                                           |                 |   |
|   | <In |                                           |                 |   |
|   | dir |                                           |                 |   |
|   | izz |                                           |                 |   |
...
|   | *   |                                           |                 |   |
+---+-----+-------------------------------------------+-----------------+---+
|   | **1 | numero civico riferito all'indirizzo (non | formato         |   |
|   | .2. | indicare se già presente nel campo        | alfanumerico    |   |
|   | 2.2 | indirizzo)                                |                 |   |
|   | <Nu |                                           |                 |   |
|   | mer |                                           |                 |   |
|   | oCi |                                           |                 |   |
...
|   | *   |                                           |                 |   |
+---+-----+-------------------------------------------+-----------------+---+
|   | **1 | Codice Avviamento Postale                 | formato         |   |
|   | .2. |                                           | numerico        |   |
|   | 2.3 |                                           |                 |   |
|   | <CA |                                           |                 |   |
|   | P>* |                                           |                 |   |
...
|   | *   |                                           |                 |   |
+---+-----+-------------------------------------------+-----------------+---+
|   | **1 | sigla della provincia di appartenenza del | [**RM**],       |   |
|   | .2. | comune indicato nel campo                 | [**MI**],       |   |
|   | 2.5 |                                           | [**…**]         |   |
|   | <Pr | **1.2.2.4**                               |                 |   |
|   | ovi |                                           |                 |   |
|   | nci |                                           |                 |   |
...
|   | *   |                                           |                 |   |
+---+-----+-------------------------------------------+-----------------+---+
|   | **1 | codice della nazione espresso secondo lo  | [**IT**],       |   |
|   | .2. | standard ISO 3166-1 alpha-2 code          | [**ES**],       |   |
|   | 2.6 |                                           | [**DK**],[**…** |   |
|   | <Na |                                           | ]               |   |
|   | zio |                                           |                 |   |
|   | ne> |                                           |                 |   |
...
|   | **  |                                           |                 |   |
+---+-----+-------------------------------------------+-----------------+---+
|   | **1 | ditta, denominazione o ragione sociale    | Ministero dei   |   |
|   | .4. | (ditta, impresa, società, ente), da       | Beni e delle    |   |
|   | 1.3 | valorizzare in alternativa ai campi       | Attività        |   |
|   | .1* | **1.4.1.3.2** e **1.4.1.3.3**             | Culturali e del |   |
|   | *   |                                           | Turismo         |   |
|   |     |                                           |                 |   |
|   | **< |                                           |                 |   |
|   | Den |                                           |                 |   |
...
|   | 2   | committente (nel caso di somministrazione |                 |   |
|   | <Se | di servizi quali energia elettrica, gas … |                 |   |
|   | de> | , i dati possono fare riferimento         |                 |   |
|   | **  | all'ubicazione dell'utenza, ex DM         |                 |   |
|   |     | 370/2000)                                 |                 |   |
+---+-----+-------------------------------------------+-----------------+---+
|   | **1 | indirizzo della sede del cessionario /    | Via del         |   |
|   | .4. | committente (nome della via, piazza etc.) | Collegio Romano |   |
|   | 2.1 |                                           |                 |   |
|   | <In |                                           |                 |   |
|   | dir |                                           |                 |   |
|   | izz |                                           |                 |   |
...
|   | *   |                                           |                 |   |
+---+-----+-------------------------------------------+-----------------+---+
|   | **1 | numero civico riferito all'indirizzo (non | 27              |   |
|   | .4. | indicare se già presente nel campo        |                 |   |
|   | 2.2 | indirizzo)                                |                 |   |
|   | <Nu |                                           |                 |   |
|   | mer |                                           |                 |   |
|   | oCi |                                           |                 |   |
...
|   | *   |                                           |                 |   |
+---+-----+-------------------------------------------+-----------------+---+
|   | **1 | Codice Avviamento Postale                 | 00186           |   |
|   | .4. |                                           |                 |   |
|   | 2.3 |                                           |                 |   |
|   | <CA |                                           |                 |   |
|   | P>* |                                           |                 |   |
|   | *   |                                           |                 |   |
+---+-----+-------------------------------------------+-----------------+---+
|   | **1 | comune relativo alla stabile              | ROMA            |   |
|   | .4. | organizzazione in Italia                  |                 |   |
|   | 2.4 |                                           |                 |   |
|   | <Co |                                           |                 |   |
|   | mun |                                           |                 |   |
|   | e>* |                                           |                 |   |
...
|   |                    | sarà negativo                 |           |   |
+---+--------------------+-------------------------------+-----------+---+
|   | **2.2.1.9          | prezzo unitario del           | formato   |   |
|   | <PrezzoUnitario>** | bene/servizio; nel caso di    | numerico; |   |
|   |                    | beni ceduti a titolo di       | i         |   |
|   |                    | sconto, premio o abbuono,     | decimali  |   |
|   |                    | l'importo indicato            | vanno     |   |
|   |                    | rappresenta il "valore        | separati  |   |
|   |                    | normale"                      | dall'inte |   |
|   |                    |                               | ro        |   |
|   |                    |                               | con il    |   |
|   |                    |                               | carattere |   |
...
|   | *   |                              |                             |   |
+---+-----+------------------------------+-----------------------------+---+
|   | **2 | aliquota (%) IVA applicata   | formato numerico; i         |   |
|   | .2. | al bene/servizio             | decimali vanno separati     |   |
...
|   | >** |                              |                             |   |
+---+-----+------------------------------+-----------------------------+---+
|   | **2 | natura dell'operazione se    | valore ammesso: N2          |   |
|   | .2. | non rientra tra quelle       |                             |   |
|   | 1.1 | imponibili (il campo         |                             |   |
|   | 4   |                              |                             |   |
...
|   | >** |                              |                             |   |
+---+-----+------------------------------+-----------------------------+---+
|   | **2 | modalità di pagamento        | Valore ammesso: [**MP05**]: |   |
|   | .4. |                              | bonifico                    |   |
|   | 2.2 |                              |                             |   |
|   | **  |                              |                             |   |
|   |     |                              |                             |   |
...
|   | **  |                              |                             |   |
+---+-----+------------------------------+-----------------------------+---+
|   | **2 | importo relativo al          | formato numerico; i         |   |
|   | .4. | pagamento                    | decimali vanno separati     |   |
|   | 2.6 |                              | dall'intero con il          |   |
|   | **  |                              | carattere '.' (punto)       |   |
|   |     |                              |                             |   |
|   | **< |                              | valore da indicare: lo      |   |
|   | Imp |                              | stesso valore del campo     |   |
|   | ort |                              | 2.1.1.9                     |   |
|   | oPa |                              |                             |   |
...
|   | 2.1 | internazionale che consente  | effettuato il bonifico      |   |
|   | 3   | di identificare, in maniera  |                             |   |
|   | <IB | standard, il conto corrente  |                             |   |
|   | AN> | del                          |                             |   |
|   | **  |                              |                             |   |
|   |     | beneficiario )               |                             |   |
+---+-----+------------------------------+-----------------------------+---+
